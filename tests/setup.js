...
var THREE = {
  ...
  MeshStandardMaterial: function(opts) { var o = Object.assign({ type:'MeshStandardMaterial', dispose() {}, clone() { return new THREE.MeshStandardMaterial(opts); } }, opts || {}); if (o.color !== undefined && typeof o.color !== 'object') { var c = o.color; o.color = { _hex: c, getHex() { return this._hex; }, setHex(v) { this._hex = v; return this; }, clone() { return new THREE.Color(this._hex); } }; } return o; },
  MeshBasicMaterial: function(opts) { var o = Object.assign({ type:'MeshBasicMaterial', dispose() {}, clone() { return new THREE.MeshBasicMaterial(opts); } }, opts || {}); if (o.color !== undefined && typeof o.color !== 'object') { var c = o.color; o.color = { _hex: c, getHex() { return this._hex; }, setHex(v) { this._hex = v; return this; }, clone() { return new THREE.Color(this._hex); } }; } return o; },
  MeshPhysicalMaterial: function(opts) { var o = Object.assign({ type:'MeshPhysicalMaterial', dispose() {}, clone() { return new THREE.MeshPhysicalMaterial(opts); } }, opts || {}); if (o.color !== undefined && typeof o.color !== 'object') { var c = o.color; o.color = { _hex: c, getHex() { return this._hex; }, setHex(v) { this._hex = v; return this; }, clone() { return new THREE.Color(this._hex); } }; } return o; },
  MeshPhongMaterial: function(opts) { var o = Object.assign({ type:'MeshPhongMaterial', dispose() {} }, opts || {}); if (o.color !== undefined && typeof o.color !== 'object') { var c = o.color; o.color = { _hex: c, getHex() { return this._hex; }, setHex(v) { this._hex = v; return this; }, clone() { return new THREE.Color(this._hex); } }; } return o; },
