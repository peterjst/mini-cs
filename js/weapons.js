...
(function() {
  ...
  var WEAPON_DEFS = {
    ...
    pistol:  { name: 'Pistol (USP)',    damage: 28,  fireRate: 3.5, magSize: 12,       reserveAmmo: 36,       reloadTime: 1.8, price: 0,    range: 200, auto: false, isKnife: false, isGrenade: false, spread: 0.012, pellets: 1, penetration: 1, penDmgMult: 0.5, recoilUp: 0.014, recoilSide: 0.003, fovPunch: 1.0, screenShake: 0.02, flashColor: 0xffaa33, flashIntensity: 2.5 },
    smg:     { name: 'SMG (MP5)',       damage: 22,  fireRate: 12,  magSize: 25,       reserveAmmo: 75,       reloadTime: 2.2, price: 1250, range: 150, auto: true,  isKnife: false, isGrenade: false, spread: 0.045, pellets: 1, penetration: 1, penDmgMult: 0.4, killReward: 600, recoilUp: 0.010, recoilSide: 0.004, fovPunch: 0.8, screenShake: 0.03, flashColor: 0xffbb44, flashIntensity: 3.0 },
    shotgun: { name: 'Shotgun (Nova)',  damage: 18,  fireRate: 1.2, magSize: 6,        reserveAmmo: 24,       reloadTime: 2.8, price: 1800, range: 30,  auto: false, isKnife: false, isGrenade: false, spread: 0.09,  pellets: 8, penetration: 0, penDmgMult: 0, recoilUp: 0.044, recoilSide: 0.008, fovPunch: 2.0, screenShake: 0.06, flashColor: 0xffcc55, flashIntensity: 5.0 },
    rifle:   { name: 'Rifle (AK-47)',  damage: 36,  fireRate: 10,  magSize: 30,       reserveAmmo: 90,       reloadTime: 2.5, price: 2700, range: 200, auto: true,  isKnife: false, isGrenade: false, spread: 0.006, pellets: 1, penetration: 2, penDmgMult: 0.65, recoilUp: 0.021, recoilSide: 0.005, fovPunch: 1.2, screenShake: 0.04, flashColor: 0xff8822, flashIntensity: 4.0 },
