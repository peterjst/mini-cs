...
(function() {
  ...
  GAME._maps.push({
    ...
    build: function(scene) {
      ...
      D(decorHigh, 0.12, 0.18, 0.06, metalMat(0x222222), -19.6, 1.5, -5); // nozzle
      ...
      D(decorHigh, 0.01, 0.1, 0.02, darkMetal, 0, 4.05, -19.85); // minute hand
      D(decorHigh, 0.08, 0.01, 0.02, darkMetal, 0.04, 4.0, -19.85); // hour hand

      // Wet floor sign (triangle shape approximated)
      D(decorHigh, 0.4, 0.6, 0.02, emissiveMat(0xffeb3b, 0xffff00, 0.3), 3, 0.3, -3);
      D(decorHigh, 0.35, 0.02, 0.2, metalMat(0x333333), 3, 0.01, -3); // base
      ...
      D(decorHigh, 0.01, 0.06, 0.01, woodMat(0xdaa520), -14.2, 0.92, -13.5); // pencil
